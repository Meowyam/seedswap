  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved seed as @seed" do
        ...
        post :create, {:seed => { "name" => "invalid value" }}, valid_session
        assigns(:seed).should be_a_new(Seed)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested seed" do
        ...
        Seed.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => seed.to_param, :seed => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the seed as @seed" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Seed.any_instance.stub(:save).and_return(false)
        put :update, {:id => seed.to_param, :seed => { "name" => "invalid value" }}, valid_session
        assigns(:seed).should eq(seed)
      end
